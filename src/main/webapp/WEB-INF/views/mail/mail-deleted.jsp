									...
									<div class="mailbox-controls">
										...
										<div class="btn-group">
											...
											<a type="button" class="btn btn-default btn-sm"
												href='mail-deleted.action?pageNo=1'> <i
												class="fas fa-reply"></i></a> <a type="button"
												class="btn btn-default btn-sm"
												href='mail-deleted.action?pageNo=${ pageCount }'> <i
												class="fas fa-share"></i></a>
										</div>
										<!-- /.btn-group -->
										<a type="button" class="btn btn-default btn-sm"
											href='mail-deleted.action'><i class="fas fa-sync-alt"></i> </a>
										<div class="float-right">
											${ mailCount }
											<div class="btn-group">
												<a type="button" class="btn btn-default btn-sm"
													href='mail-deleted.action?pageNo=${ pageBefore }'> <i
													class="fas fa-chevron-left"></i>
												</a> <a type="button" class="btn btn-default btn-sm"
													href='mail-deleted.action?pageNo=${ pageNext }'> <i
												...
												<c:forEach var="mail" items="${ mails }">
														<tr class='mail-tr' data-mail-no='${mail.mailNo}'
															...
															<td style="text-align: left; padding-left: 5px;"><a
																href='mail-delete-detail.action?mailNo=${ mail.mailNo }&pageNo=${ pageNo }'>
																	${ mail.title } </a></td>
		...
		$(function() {
			...
			$('.mail-tr').on(
					...
					function(event) {
						...
						location.href = 'mail-delete-detail.action?mailNo='+ mailNo + '&pageNo=' + ${pageNo};
					});
		})
	</script>
</body>
